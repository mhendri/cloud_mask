...
def genImage(bands, enhanced, indy, fig):
    ...
    file_name_myd021km = r'C:\Users\Iraz\Desktop\data325\PARASOL_PM01-L2_2007-03-25T10-07-46_V1.46-public-release.hdf'
    ...
    selected_sds = file_myd021km.select('mband02')
    ...
    selected_sds = file_myd021km.select('mband07')
    ...
    selected_sds = file_myd021km.select('Latitude')
    myd03_lat = selected_sds.get()

    selected_sds = file_myd021km.select('Longitude')
